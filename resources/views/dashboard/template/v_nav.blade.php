...
<div id="header" class="app-header">
    ...
    <div class="brand">
        <a href="index.html" class="brand-logo">
            ...
            <span class="brand-text">PLN Monitoring Dashboard</span>
        </a>
    </div>
    <!-- END brand -->
        ...
        <div class="menu">
            ...
            <div class="menu-item has-sub">
                ...
                <div class="menu-submenu">
                    <div class="menu-item">
                        <a href="area?page=0" class="menu-link">
                            <span class="menu-text">Bandung</span>
                        </a>
                    </div>
                </div>
            </div>
            <div class="menu-item has-sub">
                ...
                <div class="menu-submenu">
                    <div class="menu-item">
                        <a href="unit?id=1" class="menu-link">
                            <span class="menu-text">Generator 1</span>
                        </a>
                    </div>
                </div>
            </div>
